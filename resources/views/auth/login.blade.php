...
<body class="auth-page">
    <main class="auth-shell">
        ...
        <section class="auth-card">
            ...
            <p class="auth-demo">Demo murid: <strong>murid@educore.test</strong> / password<br>Demo admin: <strong>admin@educore.test</strong> / password<br>Demo guru: <strong>guru@educore.test</strong> / password</p>
        </section>
    </main>
</body>
</html>
